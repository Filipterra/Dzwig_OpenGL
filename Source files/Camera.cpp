...
Camera::Camera(): front(glm::vec3(0.0f, 0.0f, 1.0f)), yaw(YAW), pitch(PITCH), movementSpeed(SPEED), mouseSensitivity(SENSITIVITY), zoom(ZOOM)
{
...
{
	float velocity = movementSpeed * deltaTime * (zoom/ZOOM);
